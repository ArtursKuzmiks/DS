...
class LinkQueue {
    ...
    LinkQueue(int maxSize) {
        if (maxSize <= 0)
            throw new IllegalStateException("Size jabut lielakam par 0");
        if (maxSize > 15)
            ...
            for (; ; ) {
                ...
                switch (menu) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        System.out.println("Method Full ir patiess ja rinda ir "
                                + size + " elementi: " + que.isFull());
                        break;
                    case 7:
                        if (que.isEmpty())
                            System.out.println("Rinda ir tuksa");
